...
# 命令行传参
parser = argparse.ArgumentParser(description="Train Raw EEG + Manual Feature Fusion Attention Model")
...
if len(paired_raw_files) == 0:
    raise RuntimeError(
        ...
        "Generate manual feature cache before training fusion attention model."
    )
...
print("\nFusion attention split summary:")
...
print("\nFusion attention sequence counts:")
...
model_name = "FusionAttentionBiLSTM" if bidirectional else "FusionAttentionLSTM"
